...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Solve, format and polish any assignment with AI. Upload PDFs, DOCX, images or paste text. Get human-like, referenced answers in seconds." },
      { property: "og:title", content: "Assignmate — AI Assignment Helper" },
      { property: "og:description", content: "AI-powered assignment solutions for students." },
